	...
	if (data[0] == 0 && data[1] == 0x06 && data[2] == 0) //写入
		{
			...
			case setrelay2:
				...
				break;
			case setrelay3:
				if (data[4] == 0&&data[5] == 0) 	{HAL_GPIO_WritePin(RELAY3_GPIO_Port, RELAY3_Pin, GPIO_PIN_RESET);B3Status[2] = 0;}
				else	{HAL_GPIO_WritePin(RELAY3_GPIO_Port, RELAY3_Pin, GPIO_PIN_SET);B3Status[2] = 1;}
				break;
			case setrelay4:
				if (data[4] == 0&&data[5] == 0) 	{HAL_GPIO_WritePin(RELAY4_GPIO_Port, RELAY4_Pin, GPIO_PIN_RESET);B3Status[3] = 0;}
				else	{HAL_GPIO_WritePin(RELAY4_GPIO_Port, RELAY4_Pin, GPIO_PIN_SET);B3Status[3] = 1;}
				break;
			case setrelay5:
				if (data[4] == 0&&data[5] == 0) 	{HAL_GPIO_WritePin(RELAY5_GPIO_Port, RELAY5_Pin, GPIO_PIN_RESET);B3Status[4] = 0;}
				else	{HAL_GPIO_WritePin(RELAY5_GPIO_Port, RELAY5_Pin, GPIO_PIN_SET);B3Status[4] = 1;}
				break;
			case setrelay6:
				if (data[4] == 0&&data[5] == 0) 	{HAL_GPIO_WritePin(RELAY6_GPIO_Port, RELAY6_Pin, GPIO_PIN_RESET);B3Status[5] = 0;}
				else	{HAL_GPIO_WritePin(RELAY6_GPIO_Port, RELAY6_Pin, GPIO_PIN_SET);B3Status[5] = 1;}
				break;
			case setrelay7:
				if (data[4] == 0&&data[5] == 0) {	HAL_GPIO_WritePin(RELAY7_GPIO_Port, RELAY7_Pin, GPIO_PIN_RESET);B3Status[6] = 0;}
				else	{HAL_GPIO_WritePin(RELAY7_GPIO_Port, RELAY7_Pin, GPIO_PIN_SET);B3Status[6] = 1;}
				break;
			case setrelay8:
				if (data[4] == 0&&data[5] == 0) 	{HAL_GPIO_WritePin(RELAY8_GPIO_Port, RELAY8_Pin, GPIO_PIN_RESET);B3Status[7] = 0;}
				else {HAL_GPIO_WritePin(RELAY8_GPIO_Port, RELAY8_Pin, GPIO_PIN_SET);B3Status[7] = 1;}
				break;
